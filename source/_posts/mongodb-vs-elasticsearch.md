...
2017年已过去，如果用一句话来总结自己，那将是：收获爱情，提升职能的一年。总体来说过去的一年不算差，也不算太好。没有什么大风大浪，事业和爱情稳步进行着...
...
最近正是在做Elasticsearch数据库相关的业务开发，因此对于两者的特点有了一些新的看法。
...
**Mongodb**：并发查询性能较好，适合做高并发量业务后端数据库。

**Elasticsearch**：对于聚合分析处理的性能极好，对于海量数据聚合分析优选该数据库。
